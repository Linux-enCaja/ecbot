 ...
 */
//Common signals
#define ROBOSTIX_GPIO_ATM_RESET	AT91_PIN_PA10    // output active low
#define ROBOSTIX_GPIO_ATM_MISO  AT91_PIN_PA12    // input
#define ROBOSTIX_GPIO_ATM_MOSI  AT91_PIN_PA13    // output

int ROBOSTIX_GPIO_ATM_SCK[]  = {AT91_PIN_PC24, AT91_PIN_PA11, AT91_PIN_PA11, AT91_PIN_PC24, AT91_PIN_PA11}; // UM1, US1, US2, US3, US4
...
static  int    ndevs = 2;   // The ECBOT have 5 AVRs
...
int robostix_ioctl( struct inode *inode, struct file *file, unsigned int cmd, unsigned long arg )
{
    ...
    switch ( cmd )
    {
        ...
        case PPRDATA:   // Read data register
        {
            ...
            mosi  = at91_get_gpio_value( ROBOSTIX_GPIO_ATM_MOSI );
        ...
        case PPWDATA:   // Write data register
        {
            ...
            SET_GPIO( ROBOSTIX_GPIO_ATM_MOSI, mosi );
            break;
        }
