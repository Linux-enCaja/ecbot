...
int main()
{
   ...
   objects[0].lower_bound.channel[0] = 0xC0;
   objects[0].lower_bound.channel[1] = 0x20;
   objects[0].lower_bound.channel[2] = 0x20;
   objects[0].upper_bound.channel[0] = 0xf0;
   objects[0].upper_bound.channel[1] = 0x40;
   objects[0].upper_bound.channel[2] = 0x40;
   objects[0].x0 = 0xffff;
   objects[0].y0 = 0xff;
   objects[0].objectValid = 0;
   ...
   objects[1].upper_bound.channel[2] = 0x90;
   objects[1].x0 = 0xffff;
   objects[1].y0 = 0xff;
   objects[1].objectValid = 0;


   tracking_findConnectedness(image, objects);
   printf("left=%x, right=%x, top=%x, bottom=%x \n",objects[0].x0, objects[0].x1, objects[0].y0, objects[0].y1);
   printf("left=%x, right=%x, top=%x, bottom=%x \n",objects[1].x0, objects[1].x1, objects[1].y0, objects[1].y1);

   image_png.square(objects[0].x1,objects[0].y1,objects[0].x0,objects[0].y0,255,255,255);
   image_png.square(objects[1].x1,objects[1].y1,objects[1].x0,objects[1].y0,255,255,255);
   image_png.close();
